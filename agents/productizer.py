...
class ProductizerAgent(BaseAgent):
    ...
    def _generate_sales_kit(self, profile: Dict[str, Any], filename: str) -> Dict[str, Any]:
        ...
        prompt = f"""
        You are an Elite Solutions Engineer and Product Marketer for Assay.
        Assay is an AI Data Analyst that replaces manual dashboarding with autonomous insights.
        
        Your Goal: Create a "Vertical Sales Kit" based on this dataset. 
        We want to sell Assay to a specific industry by showing them a concrete use case using this data.
        ...
        Step 4: Script a "Assay Demo" that solves these pains using the provided columns.
        ...
        {{
            ...
            "elevator_pitch": "2-3 sentences selling Assay to this persona.",
            "demo_script": [
                {{
                    "step": "1. Ask this question...",
                    "action": "Assay will generate...",
    ...
    def _save_sales_kit(self, kit: Dict[str, Any], filename: str) -> Path:
        ...
        if "raw_content" in kit:
            ...
            content = f"""# 🚀 Assay Sales Kit: {kit.get('vertical')}
...
---
*Generated by Assay Productizer Agent on {datetime.now().strftime('%Y-%m-%d')}*
"""
