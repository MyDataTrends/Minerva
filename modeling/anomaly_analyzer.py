...
# Ensure external imports get the canonical class from analyzers package
from .analyzers.anomaly import AnomalyAnalyzer as _AnomalyImpl
AnomalyAnalyzer = _AnomalyImpl
